...
public class Conta {
	...
	private int senhadetransacao;
	
	
	public Conta(Cliente cliente, int numeroAgencia, double saldo, int senhaAcesso, int senhadetransacao) {
	...
	private void verSaldo() {
		...
		JOptionPane.showMessageDialog(null, 
				" Saldo atual: R$" + this.saldo,  // Mensagem
                "Saldo",               // Título da janela
                JOptionPane.INFORMATION_MESSAGE, // Tipo de ícone
                null);
	}
	...
	private boolean sacar() {
		...
		boolean confirmado = confirmaSenhadetransacao();
